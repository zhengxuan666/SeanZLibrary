...
import com.seanz.library.mvp.delegate.ActivityMvpDelegate;
import com.seanz.library.mvp.delegate.ActivityMvpDelegateImpl;
import com.seanz.library.mvp.delegate.MvpDelegateCallback;
 ...
 * @param <P>
 */
public abstract class MvpActivity<V extends IMvpView, P extends IMvpPresenter<V>> extends BaseActivity implements IMvpView, MvpDelegateCallback<V, P> {
